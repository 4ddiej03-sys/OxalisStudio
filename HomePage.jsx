        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
          <div style={{ maxWidth: 900 }}>
            ...
            <p style={{
              ...
              app development, brand identity, advertising, UI/UX design and creative phohtography.
              Welcome to OXALIS, where creativity meets strategy, and every brand finds its unique voice.
        ...
        <div style={{ display: "flex", gap: 60, whiteSpace: "nowrap", animation: "marquee 20s linear infinite" }}>
          {[...Array(3)].map((_, i) => (
            <span key={i} style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 18, fontWeight: 300, color: "rgba(255,255,255,0.7)", letterSpacing: 3, flexShrink: 0 }}>
              App Development &nbsp;·&nbsp; Brand Identity &nbsp;·&nbsp; Creative Advertising &nbsp;·&nbsp; UI/UX Design &nbsp;·&nbsp; Photography &nbsp;·&nbsp; Food & Drink Content &nbsp;·&nbsp;
            </span>
          ))}
        </div>

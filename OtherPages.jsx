      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 60, marginBottom: 80 }}>
          <div>
            ...
            <div style={{ fontFamily: sans, fontSize: 10, color: "#555", letterSpacing: 3, textTransform: "uppercase", marginBottom: 20 }}>Creative Direction</div>
            <p style={{ fontFamily: sans, fontSize: 14, color: "rgba(245,240,232,0.4)", lineHeight: 1.8, maxWidth: 280 }}>
              New Zealand creative studio specialising in app development, brand identity and creative direction.
            </p>
          </div>
          <div>
